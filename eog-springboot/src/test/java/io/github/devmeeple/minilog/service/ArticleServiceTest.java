...
class ArticleServiceTest {
    ...
    void testGetFeedListByFollowerId() {
        ArticleResponseDto article = articleService.getFeedListByFollowerId(follow1.getFollower().getId()).getFirst();
        ArticleResponseDto target = articleService.getArticleListByUserId(article.getAuthorId()).getFirst();
